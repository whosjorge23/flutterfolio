...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1263: (x0,x1) => x0.createElement(x1),
      _1268: (x0,x1,x2) => x0.addEventListener(x1,x2),
      _1279: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1280: x0 => x0.decode(),
      _1281: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1282: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      ...
      _1285: x0 => x0.send(),
      _1286: () => new XMLHttpRequest(),
      _1287: Date.now,
      _1289: s => new Date(s * 1000).getTimezoneOffset() * 60,
      _1290: s => {
      ...
      _1292: () => typeof dartUseDateNowForTicks !== "undefined",
      _1293: () => 1000 * performance.now(),
      _1294: () => Date.now(),
      _1295: () => {
      ...
      _1297: () => new WeakMap(),
      _1298: (map, o) => map.get(o),
      _1299: (map, o, v) => map.set(o, v),
      _1300: x0 => new WeakRef(x0),
      _1301: x0 => x0.deref(),
      _1307: () => globalThis.WeakRef,
      ...
      _1319: s => s.trimLeft(),
      _1320: s => s.trimRight(),
      _1321: (string, times) => string.repeat(times),
      _1322: Function.prototype.call.bind(String.prototype.indexOf),
      _1323: (s, p, i) => s.lastIndexOf(p, i),
      _1324: (string, token) => string.split(token),
      _1325: Object.is,
      _1326: (a, i) => a.push(i),
      _1327: (a, i) => a.splice(i, 1)[0],
      _1329: (a, l) => a.length = l,
      _1330: a => a.pop(),
      _1331: (a, i) => a.splice(i, 1),
      _1332: (a, s) => a.join(s),
      _1333: (a, s, e) => a.slice(s, e),
      _1334: (a, s, e) => a.splice(s, e),
      _1336: a => a.length,
      _1338: (a, i) => a[i],
      _1339: (a, i, v) => a[i] = v,
      _1341: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1342: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1343: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1344: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1345: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1346: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1347: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1348: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1350: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1351: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1352: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1353: (t, s) => t.set(s),
      _1355: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1357: o => o.buffer,
      _1358: o => o.byteOffset,
      _1359: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1360: (b, o) => new DataView(b, o),
      _1361: (b, o, l) => new DataView(b, o, l),
      _1362: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1363: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1364: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1365: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1366: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1367: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1368: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1369: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1370: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1371: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1372: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1373: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1376: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1377: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1378: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1379: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1380: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1381: Function.prototype.call.bind(DataView.prototype.setFloat64),
      ...
      _1398: o => Object.keys(o),
      _1399: (ms, c) =>
      setTimeout(() => dartInstance.exports.$invokeCallback(c),ms),
      _1400: (handle) => clearTimeout(handle),
      _1401: (ms, c) =>
      setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
      _1402: (handle) => clearInterval(handle),
      _1403: (c) =>
      queueMicrotask(() => dartInstance.exports.$invokeCallback(c)),
      _1404: () => Date.now(),
      _1405: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1406: (x0,x1) => globalThis.fetch(x0,x1),
      _1407: (x0,x1) => x0.get(x1),
      _1408: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1408(f,arguments.length,x0,x1,x2) }),
      _1409: (x0,x1) => x0.forEach(x1),
      _1411: () => new AbortController(),
      _1412: x0 => x0.getReader(),
      _1413: x0 => x0.read(),
      _1414: x0 => x0.cancel(),
      _1441: (s, m) => {
        try {
      ...
      _1442: (x0,x1) => x0.exec(x1),
      _1443: (x0,x1) => x0.test(x1),
      _1444: x0 => x0.pop(),
      _1446: o => o === undefined,
      _1448: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
      _1450: o => {
        const proto = Object.getPrototypeOf(o);
        return proto === Object.prototype || proto === null;
      },
      _1451: o => o instanceof RegExp,
      _1452: (l, r) => l === r,
      _1453: o => o,
      _1454: o => o,
      _1455: o => o,
      ...
      _1457: o => o.length,
      _1459: (o, i) => o[i],
      _1460: f => f.dartFunction,
      _1461: () => ({}),
      _1462: () => [],
      _1464: () => globalThis,
      _1465: (constructor, args) => {
      ...
      _1467: (o, p) => o[p],
      _1468: (o, p, v) => o[p] = v,
      _1469: (o, m, a) => o[m].apply(o, a),
      _1471: o => String(o),
      _1472: (p, s, f) => p.then(s, f),
      _1473: o => {
      ...
      _1474: o => [o],
      _1475: (o0, o1) => [o0, o1],
      _1476: (o0, o1, o2) => [o0, o1, o2],
      _1477: (o0, o1, o2, o3) => [o0, o1, o2, o3],
      ...
      _1479: (jsArray, jsArrayOffset, wasmArray, wasmArrayOffset, length) => {
      ...
      _1492: x0 => x0.groups,
      _1493: x0 => x0.flags,
      _1494: x0 => x0.multiline,
      _1495: x0 => x0.ignoreCase,
      _1496: x0 => x0.unicode,
      _1497: x0 => x0.dotAll,
      _1498: (x0,x1) => x0.lastIndex = x1,
      _1499: (o, p) => p in o,
      _1500: (o, p) => o[p],
      _1503: x0 => x0.random(),
      _1506: () => globalThis.Math,
      _1507: Function.prototype.call.bind(Number.prototype.toString),
      _1508: Function.prototype.call.bind(BigInt.prototype.toString),
      _1509: Function.prototype.call.bind(Number.prototype.toString),
      _1510: (d, digits) => d.toFixed(digits),
      _1514: () => globalThis.document,
      _1534: x0 => x0.src,
      _1535: (x0,x1) => x0.src = x1,
      _1536: x0 => x0.naturalWidth,
      _1537: x0 => x0.naturalHeight,
      _1553: x0 => x0.status,
      _1554: (x0,x1) => x0.responseType = x1,
      _1556: x0 => x0.response,
      _3389: () => globalThis.window,
      _3451: x0 => x0.navigator,
      _3840: x0 => x0.userAgent,
      _5995: x0 => x0.signal,
      _7831: x0 => x0.value,
      _7833: x0 => x0.done,
      _8535: x0 => x0.url,
      _8537: x0 => x0.status,
      _8539: x0 => x0.statusText,
      _8540: x0 => x0.headers,
      _8541: x0 => x0.body,
...
"Giorgio Giannotta - Mobile Developer",
"_heroController",
...
"This is the blog page where you can find articles and posts.",
"_blogsFuture",
...
"sliderTheme",
"QR Code Generator",
"Enter the text or URL to convert into a QR Code:",
"Example. Hello World! o https://yoursite.com",
"Generate QR Code",
...
"RobotoMono",
"https://www.linkedin.com/in/giorgio-maria-giannotta/",
"platformDefault",
"inAppWebView",
"inAppBrowserView",
...
"externalApplication",
"LaunchMode.",
"https://github.com/whosjorge23",
"mailto:g.giannotta91@gmail.com",
"Mashfrog Group",
"July 2023 - Present",
"Mobile Developer",
"Pixora",
...
"Timeline",
"Projects",
"Kanban and Mood in One",
"https://is1-ssl.mzstatic.com/image/thumb/Purple221/v4/a8/61/a7/a861a794-f005-4a8d-6859-9046a295eb3b/AppIcon-0-0-85-220-0-5-0-2x.png/460x0w.webp",
"https://apps.apple.com/us/app/mind-dock/id6747912827",
"Mind Dock",
"Edit plist files easily",
"https://is1-ssl.mzstatic.com/image/thumb/Purple211/v4/3b/54/f8/3b54f80f-f20f-52a7-ec6f-b674764b022e/AppIcon-0-0-85-220-0-5-0-2x.png/460x0w.webp",
"https://apps.apple.com/us/app/giraffe-plist-editor/id6746355731",
"Giraffe Plist Editor",
"Better sleep, serene mind",
"https://is1-ssl.mzstatic.com/image/thumb/Purple211/v4/f6/2b/e0/f62be0af-8f73-1f52-75b0-ee8e784e1336/AppIcon-0-0-1x_U007emarketing-0-8-0-0-85-220.png/460x0w.webp",
"https://apps.apple.com/us/app/sleepie-cycles/id6740722881",
"Sleepie Cycles",
"Find and Save Fishing Spots",
"https://is1-ssl.mzstatic.com/image/thumb/Purple221/v4/1b/54/d0/1b54d097-f6f0-3ec6-790f-a1779bf54ee5/AppIcon-0-0-1x_U007emarketing-0-8-0-0-85-220.png/460x0w.webp",
"https://apps.apple.com/us/app/fishing-finder/id6502875784",
"Fishing Finder",
"Simple and Clean Todo List",
"https://is1-ssl.mzstatic.com/image/thumb/Purple221/v4/b7/88/74/b788743b-fbb3-e992-e7fb-59497cf5c4c6/AppIcon-0-0-1x_U007emarketing-0-7-0-0-85-220.png/460x0w.webp",
"https://apps.apple.com/us/app/clean-todos/id6499313215",
"Clean Todos",
"Daily treats in scratch cards",
"https://is1-ssl.mzstatic.com/image/thumb/Purple211/v4/6a/e8/8e/6ae88eac-7177-37cf-b598-eb4251febf39/AppIcon-0-0-1x_U007emarketing-0-11-0-0-85-220.png/460x0w.webp",
"https://apps.apple.com/us/app/scratch-a-treat/id6747306572",
"Scratch a Treat",
"cover",
"Download",
"BoxFit.",
...
"Frameworks",
"Hi, I'm Giorgio 👋",
"Mobile Developer | Flutter Enthusiast | Apple Fan | Traveler",
"surface_variant",
"on_background",
"scrim",
"shadow",
...
"performLayout",
"performResize",
"A Gap widget must be placed directly inside a Flex widget or its fallbackDirection must not be null",
"intrinsicHeight",
"_currentSize",
"maxWidth",
"aboveBaseline",
